...
architecture top_basys3_arch of top_basys3 is 
    ...
    signal w_alu_result : std_logic_vector (7 downto 0) := "00000000";
    signal w_alu_flags : std_logic_vector (3 downto 0) := "0000";
    signal w_twocomp_sign : std_logic := '0';
    signal w_twocomp_sign_expanded : std_logic_vector (3 downto 0) := "0000";
    signal w_twocomp_hund : std_logic_vector (3 downto 0) := "0000";
    signal w_twocomp_tens : std_logic_vector (3 downto 0) := "0000";
    signal w_twocomp_ones : std_logic_vector (3 downto 0) := "0000";
...
begin
	-- PORT MAPS ----------------------------------------;
	button_debouncer_inst : button_debounce
	port map (	
	        clk =>  clk,
			reset => btnU,
			button => btnC,
